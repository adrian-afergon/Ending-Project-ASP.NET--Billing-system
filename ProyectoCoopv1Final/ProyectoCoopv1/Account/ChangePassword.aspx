<%@ Page Title="Cambiar contraseña" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="ChangePassword.aspx.cs" Inherits="ProyectoCoopv1.Account.ChangePassword" %>
            ...
            <div class="accountInfo">
                <fieldset class="changePassword">
                    ...
                    <p>
                        ...
                        <asp:TextBox ID="CurrentPassword" runat="server" CssClass="inputText" 
                    ...
                    <p>
                        ...
                        <asp:TextBox ID="NewPassword" runat="server" CssClass="inputText" 
                            TextMode="Password"></asp:TextBox>
                    ...
                    <p>
                        ...
                        <asp:TextBox ID="ConfirmNewPassword" runat="server" CssClass="inputText" 
                            TextMode="Password"></asp:TextBox>
