<%@ Page Title="Registrarse" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="Register.aspx.cs" Inherits="ProyectoCoopv1.Account.Register" %>
                    ...
                    <div class="accountInfo">
                        <fieldset class="register">
                            ...
                            <p>
                                ...
                                <asp:TextBox ID="Email" runat="server" CssClass="inputText"></asp:TextBox>
                            ...
                            <p>
                                ...
                                <asp:TextBox ID="Password" runat="server" CssClass="inputText" TextMode="Password"></asp:TextBox>
                            ...
                            <p>
                                ...
                                <asp:TextBox ID="ConfirmPassword" runat="server" CssClass="inputText" TextMode="Password"></asp:TextBox>
